...
from recommendation.basic_AFM_demo.data_reader import FeatureDictionary, DataParser
# from matplotlib import pyplot as plt

import recommendation.basic_AFM_demo.config as config
from recommendation.basic_AFM_demo.afm import AFM
