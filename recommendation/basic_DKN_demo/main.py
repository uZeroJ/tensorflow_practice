...
from recommendation.basic_DKN_demo.data_loader import load_data
from recommendation.basic_DKN_demo.train import train

parser = argparse.ArgumentParser()
parser.add_argument('--train_file', type=str, default='news/train.txt',
...
parser.add_argument('--transform', type=bool, default=True,
                    help='whether to transform entity embeddings')
parser.add_argument('--use_context', type=bool, default=False,
                    help='whether to use context embeddings')
...
parser.add_argument('--n_filters', type=int, default=128,
                    help='number of filters for each size in KCNN')
